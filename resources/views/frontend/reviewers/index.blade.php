                ...
                <div class="bg-white mt-4">
                    ...
                    <form method="POST" action="{{ route('reviewer.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="flex flex-wrap overflow-hidden md:-mx-1 lg:-mx-1 xl:-mx-1">
                            ...
                            <div class="w-full overflow-hidden md:my-1 md:px-1 md:w-1/2 lg:my-1 lg:px-1 lg:w-1/2 xl:my-1 xl:px-1 xl:w-1/2">
                                <input type="text" name="contact_number" class="w-full px-3 py-2 border-2 outline-none @error('contact_number') border-red-500 focus:bg-red-100 @else focus:border-blue-700 @enderror" value="{{ old('contact_number') }}" autocomplete="mobile_number" placeholder="Contact Number">
                            ...
                            <div class="w-full overflow-hidden md:my-1 md:px-1 md:w-1/2 lg:my-1 lg:px-1 lg:w-1/2 xl:my-1 xl:px-1 xl:w-1/2">
                                <input type="text" name="job_type" class="w-full px-3 py-2 border-2 outline-none @error('job_type') border-red-500 focus:bg-red-100 @else focus:border-blue-700 @enderror" value="{{ old('job_type') }}" autocomplete="job_type" placeholder="Job Type">
                                @error('job_type')
                                <p class="text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="w-full overflow-hidden md:my-1 md:px-1 md:w-1/2 lg:my-1 lg:px-1 lg:w-1/2 xl:my-1 xl:px-1 xl:w-1/2">
                                <input type="text" name="degree" class="w-full px-3 py-2 border-2 outline-none @error('degree') border-red-500 focus:bg-red-100 @else focus:border-blue-700 @enderror" value="{{ old('degree') }}" autocomplete="degree" placeholder="Highest Degree">
                                @error('degree')
                                <p class="text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="w-full overflow-hidden md:my-1 md:px-1 md:w-1/2 lg:my-1 lg:px-1 lg:w-1/2 xl:my-1 xl:px-1 xl:w-1/2">
                                <input type="text" name="keywords" class="w-full px-3 py-2 border-2 outline-none @error('keywords') border-red-500 focus:bg-red-100 @else focus:border-blue-700 @enderror" value="{{ old('keywords') }}" autocomplete="keywords" placeholder="Research Keywords">
                                @error('keywords')
                                <p class="text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="w-full overflow-hidden md:my-1 md:px-1 md:w-1/2 lg:my-1 lg:px-1 lg:w-1/2 xl:my-1 xl:px-1 xl:w-1/2">
                                <input type="text" name="identifier" class="w-full px-3 py-2 border-2 outline-none @error('identifier') border-red-500 focus:bg-red-100 @else focus:border-blue-700 @enderror" value="{{ old('identifier') }}" autocomplete="identifier" placeholder="Digital Identifier">
                                @error('identifier')
                                <p class="text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="w-full overflow-hidden md:my-1 md:px-1 md:w-1/2 lg:my-1 lg:px-1 lg:w-1/2 xl:my-1 xl:px-1 xl:w-1/2">
                                ...
                                <input type="text" name="address" class="w-full px-3 py-2 border-2 outline-none @error('address') border-red-500 focus:bg-red-100 @else focus:border-blue-700 @enderror" value="{{ old('address') }}" placeholder="Affiliation / Address">
                                @error('address')
                                <p class="text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="w-full overflow-hidden md:my-1 md:px-1 md:w-1/2 lg:my-1 lg:px-1 lg:w-1/2 xl:my-1 xl:px-1 xl:w-1/2">
                                ...
                                {{-- <label>Password</label>--}}
                                <div class="w-full px-3 py-1 border-2 outline-none @error('cv') border-red-500 focus:bg-red-100 @else focus:border-blue-700 @enderror" placeholder="Upload your CV">
                                    <span class="inline-block text-gray-500 mr-2 leading-loose"> Select Your CV</span> <input name="cv" type="file">
                                </div>
                                @error('cv')
                                <p class="text-red-600">{{ $message }}</p>
                                @enderror
                          ...
                          {{--   <div class="w-full my-1 px-1">
                                 <label class="w-full block px-3 py-2 border-2 outline-none @error('avatar') border-red-500 focus:bg-red-100 @else focus:border-blue-700 @enderror">
                                     <div class="text-gray-500" >Upload Your CV</div>
                            ...
                            <div class="my-3 px-1">
                                <p class="text-sm tracking-wide">By submitting you are agree with our <a href="#" class="text-blue-700 hover:underline">terms & conditions</a>  and have read and understood the  <a href="#" class="text-blue-700 hover:underline">privacy policy.</a></p>
                            </div>
                            <div class="mt-5 w-full px-1">
                                <button type="submit" class="text-blue-800 font-bold text-lg uppercase px-8 py-3 leading-none tracking-wider border-2 border-blue-800 hover:bg-blue-800 hover:text-white">Apply</button>
                            </div>
                        </div>
                    </form>
                </div>
