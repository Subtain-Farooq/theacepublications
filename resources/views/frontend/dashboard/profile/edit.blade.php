            ...
            <div class="mt-2">
                ...
                <div class="flex flex-wrap overflow-hidden md:-mx-3 lg:-mx-4 xl:-mx-4">
                    ...
                    <div class="w-full overflow-hidden md:my-3 md:px-3 md:w-1/2 lg:my-4 lg:px-4 lg:w-1/2 xl:my-4 xl:px-4 xl:w-1/2">
                        ...
                        <div class="my-3">
                            <label class="text-lg text-blue-800">Address</label>
                            <input type="text" name="address" class="w-full px-3 py-2 border-2 outline-none @error('address') border-red-500 focus:bg-red-100 @else focus:border-blue-700 @enderror" value="{{ !is_null(old('address')) ? old('address') : Auth::user()->address }}" autocomplete="address" placeholder="Address">
                            @error('address')
                            <p class="text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
