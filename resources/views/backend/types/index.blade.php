            ...
            <table class="w-full border">
                ...
                @foreach ($types as $type)
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="border px-4 py-2">
                            <div class="flex justify-center">
                                <a href="{{ route('console.types.edit', ['id' => $type->id] ) }}" class="text-green-500 mx-2 hover:underline">Edit</a>
                                <form class="inline" method="POST" action="{{ route('console.types.destroy', ['id' => $type->id]) }}">
                                    @csrf
